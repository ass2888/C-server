...
class classicRoom extends Room {
    ...
    onJoin(client){
        ...
        console.log("=====================", "player joined", "LOG:", "players:", this.state.players.size, "max", this.maxPlayers)
        ...
        if (this.gameStarted === false) {
          if (this.state.players.size >= 2 && this.state.players.size <= this.maxPlayers) {
            ...
            console.log("=====================", "waiting for more...", "LOG:", "players:", this.state.players.size, "max", this.maxPlayers)
          }
        }
