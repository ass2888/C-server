...
// "l4x8k2m9p" (حوالي 9-10 أحرف)
            ...
            console.log("data.dir directly from client:", data.dir);
console.log("x:", data.dir.x, "y:", data.dir.y, "z:", data.dir.z);

            let bulletData = new createBullet(dir, speed, 2.0, bullet, damage, player.id, origin, data.atktype, id)

          console.log("Bullet creation FULL LOG:", "BEFORE (dir)", data.dir)
    ...
    this.state.players.forEach((player)=>{
      ...
      // console.log("moving", "X", player.x, "Z", player.z, "Inputs:", "X", player.inputX, "Z", player.inputZ)
           ...
           for (let i = this.state.bullets.length - 1; i >= 0; i--) {
             ...
             console.log("Bullet pos:", b.position.x, b.position.y, b.position.z)
