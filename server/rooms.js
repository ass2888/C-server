...
// "l4x8k2m9p" (حوالي 9-10 أحرف)
          ...
          console.log("Bullet creation FULL LOG:", "BEFORE (dir)", data.dir, "Player pos in server:", player.x, player.y, player.z, "bullet origin", data.position.x, data.position.y, data.position.z)
