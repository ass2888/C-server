    ...
    this.state.players.forEach((player)=>{
      ...
      // console.log("moving", "X", player.x, "Z", player.z, "Inputs:", "X", player.inputX, "Z", player.inputZ)
           ...
           for (let i = this.state.bullets.length - 1; i >= 0; i--) {
             ...
             console.log("========== BULLET ==========", "position", b.position.x, b.position.y, b.position.z, "velocity", b.velocity.x, b.velocity.y, b.velocity.z, 'life', b.life)
             b.position.add(b.velocity.multi(deltaTime));
b.life -= deltaTime;
             if (b.life <= 0) {
